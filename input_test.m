function [ V_in, time_v ] = input_test( cycles, PULSE_PAUSE, PULSE_LENGTH, VOLTAGE_MAX, VOLTAGE_STEP, TIME_STEP )
...
amp_vector = horzcat([VOLTAGE_STEP:VOLTAGE_STEP:VOLTAGE_MAX],[(VOLTAGE_MAX-VOLTAGE_STEP):-VOLTAGE_STEP:VOLTAGE_STEP]);
amp_vector = horzcat(amp_vector, -amp_vector);
